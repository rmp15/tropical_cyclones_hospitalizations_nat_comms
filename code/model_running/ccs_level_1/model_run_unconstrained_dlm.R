...
pdf(paste0(dir.output.plots,'medicare_rr_values_model_summary_unconstained_dlm_',causes_group,'_',years[1],'_',years[length(years)],'.pdf'),paper='a4r',height=0,width=0)
print(
...
saveRDS(mod_dlm_unconstrained, paste0(dir.output.model.output,'medicare_',causes_group,'_model_summary_',years[1],'_',years[length(years)],'.rds'))

# save model summary
write.csv(dat.results, paste0(dir.output.model.summary,'medicare_',causes_group,'_model_summary_',years[1],'_',years[length(years)],'.csv'))
