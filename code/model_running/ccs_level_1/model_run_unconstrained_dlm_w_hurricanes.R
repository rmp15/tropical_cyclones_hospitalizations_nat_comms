...
# save model summary
write.csv(dat.results, paste0(dir.output.model.summary,'medicare_',causes_group,'_model_summary_bonferroni_corrected_hurricane_separate_',years[1],'_',years[length(years)],'.csv'))
...
pdf(paste0(dir.output.plots,'forest_plot_',causes_group,'_bonferroni_corrected_',years[1],'_',years[length(years)],'.pdf'),paper='a4r',height=0,width=0)
ggplot() +
